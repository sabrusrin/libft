...
/*   Updated: 2019/11/21 18:20:20 by chermist         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int		main(void)
{
	...
	printf("\n%s\n\n", loc);
	d = f_printf("Привет, меня зовут Рустам.	|%-5c|%-10lc | %20.19s|%s|%-15S|% .4d|",\
												'h', L'😇', str, str2, L"Привет", 10);
	printf("\n%d\n", d);
	d = printf("Привет, меня зовут Рустам.	|%-5c|%-10lc | %20.19s|%s|%-15S|% .4d|",\
												'h', L'😇', str, str2, L"Привет", 10);
	printf("\n%d", d);
	return (0);
}
